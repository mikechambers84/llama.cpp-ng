...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, int value) {
            ...
            for (int i = 0; i < value; ++i) {
                params.tensor_buft_override_specs.push_back(llm_ffn_block_regex(i, LLM_FFN_EXPS_REGEX) + "=CPU");
            }
        }
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, int value) {
            ...
            for (int i = 0; i < value; ++i) {
                params.speculative.draft.tensor_buft_override_specs.push_back(llm_ffn_block_regex(i, LLM_FFN_EXPS_REGEX) + "=CPU");
            }
        }
